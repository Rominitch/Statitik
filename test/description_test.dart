...
void main() {
  ...
  test('CardDescription.toWidget', ()
  {
    ...
    {
      1: Region(1, MultiLanguageString(["Region", "Region", "Region"]), MultiLanguageString(["%s de Region", "Regionian %s", "Regionian %s"])),
      2: Region(2, MultiLanguageString(["Paris", "Paris", "Paris"]),    MultiLanguageString(["%s de Paris", "Parisian %s", "Parisian %s"]))
    };
