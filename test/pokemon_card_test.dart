...
void main() {
  ...
  test('CardMarkers', () {
    Map markers = {
      3: CardMarker(3, MultiLanguageString(["A", "A", "A"]), Colors.black, false),
      5: CardMarker(5,MultiLanguageString(["B", "B", "B"]), Colors.green, false),

      1: CardMarker(1, MultiLanguageString(["C", "C", "C"]), Colors.green, false),
      11: CardMarker(11, MultiLanguageString(["C", "C", "C"]), Colors.green, false),
      26: CardMarker(26, MultiLanguageString(["C", "C", "C"]), Colors.green, false),

      32: CardMarker(32, MultiLanguageString(["C", "C", "C"]), Colors.green, false),
      33: CardMarker(33, MultiLanguageString(["D", "D", "D"]), Colors.green, false),
      36: CardMarker(36, MultiLanguageString(["E", "E", "E"]), Colors.green, false),
      37: CardMarker(37, MultiLanguageString(["F", "F", "F"]), Colors.green, false),
    };
  ...
  test('ExtensionDrawCards', () {
    ...
    var seCard = SubExtensionCards(0, [[card[0], card[1]], [card[1]], [card[0]]], [], 0);
  ...
  test('CardEffects', () {
    ...
    for(CardEffects code in c) {
      CardEffects codeS = CardEffects.fromBytesArray(code.toBytes());
