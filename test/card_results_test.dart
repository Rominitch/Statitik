...
void main() {
  test('CardResults', () {
    Map markers = {
      0: CardMarker(0, MultiLanguageString(["A", "A", "A"]), Colors.black, false),
      1: CardMarker(1, MultiLanguageString(["B", "B", "B"]), Colors.green, false),
      2: CardMarker(2, MultiLanguageString(["C", "C", "C"]), Colors.green, false),
    };
    Map raritySets = {
