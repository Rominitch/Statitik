...
class RangeSliderWithTextThumb extends RangeSliderThumbShape {
  final double thumbRadius;
  final dynamic sliderMinValue;
  final dynamic sliderMaxValue;

  const RangeSliderWithTextThumb({
...
class WidgetSliderInfoController {
  Function     functionValue;
  Function     functionChanged;

  WidgetSliderInfoController(this.functionValue, this.functionChanged);
}

class WidgetSliderInfo extends StatefulWidget {
  final WidgetSliderInfoController controller;
  final dynamic minValue;
  final dynamic maxValue;
  final int? division;
  const WidgetSliderInfo(this.controller, this.minValue, this.maxValue, {this.division, super.key});

  @override
  State<WidgetSliderInfo> createState() => _WidgetSliderInfoState();
}

class _WidgetSliderInfoState extends State<WidgetSliderInfo> {
  @override
