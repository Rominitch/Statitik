...
© 2021 Pokémon. © 1995–2021 Nintendo/Creatures Inc./GAME FREAK inc. Pokémon et les noms des personnages Pokémon sont des marques de Nintendo.''',
      ...
      'TUTO0_0': 'Tutorial: Ajouter un tirage',
      'TUTO0_1': 'Je suis prêt',
      'TUTO0_2': "L'enregistrement d'un tirage va se faire en même temps que votre ouverture.\n\nOuvrer votre produit et regrouper vos boosters.\n",
      'TUTO0_3': "Etape 1 : Trouver son produit",
      'TUTO0_4': "Selectionner la langue des cartes.",
      'TUTO0_5': "Selectionner l'extension d'un seul des boosters de votre produit.",
      'TUTO0_6': "La liste des produits enregistrées va apparaître :\n- Les produits en gris sont spécifiques à l'extension choisi\n- Les produits en orange ont des boosters randomisés\n",
      'TUTO0_7': "Votre produit est présent",
      'TUTO0_8': "Selectionner votre produit.",
      ...
      'TUTO0_13': "- Noté sur un papier le tirage :\n   - Numero de carte (entourer si set parallèle/reverse)\n   - Le type d'énergie",
      'TUTO0_14': "- Revenez remplir quand le produit est présent.",
      'TUTO0_15': "Solution 2: ",
      'TUTO0_16': "- Traiter chaque booster à l'unité\nRefaire les étapes précédentes en selectionnant l'extension du booster à traiter et choisir le produit Booster",
      ...
      'TUTO0_22': "Sélectionner une vignette et choisisser son extension en fonction du booster que vous allez ouvrir.",
      ...
      'TUTO0_25': "Si vous avez un booster d'une extension différente ou que le nombre de booster n'est pas valide, selectionner le mode 'produit non conforme'.",
      ...
      'TUTO0_28': "Vous pouvez débaler les cartes de votre booster.",
      'TUTO0_29': "Chaque vignette représente une carte.",
      'TUTO0_30': "Nous vous conseillons de faire des piles de carte afin de les retrouver si vous avez une erreur lors de l'enregistrement.",
      ...
      'TUTO0_35': "Cela marche aussi avec les energies.",
      'TUTO0_36': "Si il n'y a pas le bon nombre de carte, vous pouvez passer en mode 'Booster non conforme'.",
      'TUTO0_37': "Une fois toutes les cartes sélectionnées, un bouton de validation apparait :",
      ...
      'TUTO0_40': "Attention carte rare : indique que plus d'une carte rare a été enregistré.",
      ...
      'TUTO0_44': "Répéter l'étape 3 jusqu'à remplir tous les boosters.\nUn bouton 'Envoyer' fera son apparition.",
