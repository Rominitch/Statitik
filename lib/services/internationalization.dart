...
class StatitikLocale {
  ...
  static Map<String, Map<String, String>> _localizedValues = {
    'en': {
      ...
      'S_B0': 'Extension',
      'S_B1': 'No result',
      'S_B2': 'Select an extension',
      'S_B3': 'Extension data are not existing for now: statistics are limited.',
      'S_B4': 'Booster',
      'S_B5': '%d whose %d with anomaly',
      'S_B6': 'Distribution for 10 cards',
      'S_B7': 'Details of extension',
      'yes':    'Yes',
      'cancel': 'Cancel',
      'warning': 'Warning',
      'delete': 'Delete',
      ...
      'TR_B4': ' Check multiple extensions',
      'TR_B5': 'Product is not conform ?',
      'TR_B6': 'Example: My boosters\' number is not correct',
      'EP_B0': 'Please select a extension\'s booster inside your product.',
      'EP_B1': 'Show names',
      'SU_B0': 'To demand improvment or register bugs:',
