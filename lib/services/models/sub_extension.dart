...
class SubExtension
{
  ...
  SubExtension.fromBytes(ByteParser parser, Collection collection) :
  ...
  List<int> toBytes() {
    return ByteEncoder.encodeInt32(id)
      ...
      + ByteEncoder.encodeString16(icon.codeUnits)
      + ByteEncoder.encodeArray16<String>(seCode, (String e) => ByteEncoder.encodeString16(e.codeUnits) )
      + ByteEncoder.encodeDateTime(out)
      + ByteEncoder.encodeInt32(seCards.id)
      + ByteEncoder.encodeInt32(extension.id)
      + ByteEncoder.encodeInt8(type.index)
      + ByteEncoder.encodeInt8(cardPerBooster);
  }
