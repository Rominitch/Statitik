...
class DescriptionData {
  ...
  DescriptionData.fromBytes(ByteParser parser) :
    multiName = parser.extractMultiLanguage()!,
    markers   = parser.extractArray16<DescriptionEffect>(
      (parser) => DescriptionEffect.values[parser.extractInt8()]
  );

  List<int> toBytes() {
    return ByteEncoder.encodeMultiLanguage(multiName)
      + ByteEncoder.encodeArray16<DescriptionEffect>(markers,
