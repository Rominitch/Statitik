...
class SubExtensionCards {
  ...
  SubExtensionCards.fromBytes(ByteParser parser, Collection collection) :
  ...
  SubExtensionCards.build(this.id, List<int> bytes, this.codeNaming, Map cardCollection, Map allSets, Map rarities, this.configuration, List<int>? energy, List<int>? noNumber) :
  ...
  SubExtensionCards.emptyDraw(this.id, this.codeNaming, this.configuration, Map allSets) : cards = [], isValid=false {
