...
class CardViewerBody extends StatefulWidget {
  ...
  Widget buildHeader(BuildContext context) {
    return Row(
        children:[
          Expanded(child: Text(se.seCards.titleOfCard(se.extension.language, idCard.numberId), style: Theme.of(context).textTheme.headlineSmall)),
...
class EffectViewer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(effect.title != null) {
      ...
      attackPanel = Row(
        children: <Widget>[
          Text(Environment.instance.collection.effects[effect.title!].name(l), style: Theme.of(context).textTheme.headlineSmall,),
    ...
    if(effect.description != null) {
      descriptionPanel = effect.description!.toWidget(Environment.instance.collection.descriptions,
          Environment.instance.collection.pokemons,
          Environment.instance.collection.effects,
          Environment.instance.collection.regions, l);
