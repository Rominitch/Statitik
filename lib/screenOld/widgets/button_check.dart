...
class ExpansionTypeButtonCheck extends ButtonCheck<ExpansionType> {
  ExpansionTypeButtonCheck(seList, value, {controller, Key? key}) : super(seList, value, controller, key: key);
